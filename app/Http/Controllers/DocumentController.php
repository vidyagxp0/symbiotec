...
// dd($document_distribution_grid);
    ...
    public function revision(Request $request, $id)
    {
        ...
        $newdoc = new Document();
        $newdoc->change_control_no = $request->change_control_no;
        ...
        $newdoc->major = intval($request->major) + 1;
        ...
        $newdoc->document_type_id = $request->document_type_id;
        ...
        $prev_doc_content = $document->doc_content;
