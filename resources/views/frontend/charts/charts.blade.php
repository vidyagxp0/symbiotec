...
<div class="my-4 row">
  ...
  <div class="my-4 row">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab4" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#hodAnalysisLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent2">
        ...
        <div class="tab-pane fade show active" id="hodAnalysisBar" role="tabpanel" aria-labelledby="home-tab">
          ...
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              ...
              <div
                class="card-text d-flex justify-content-center d-flex justify-content-center align-items-center h-100"
        ...
        <div class="tab-pane fade" id="hodAnalysisLine" role="tabpanel" aria-labelledby="profile">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab1" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#pendingTrainingLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent3">
        ...
        <div class="tab-pane fade" id="pendingTrainingLine" role="tabpanel" aria-labelledby="home-tab">
          ...
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              ...
              <div
                class="card-text d-flex justify-content-center d-flex justify-content-center align-items-center h-100"
                id="pendingTrainingAnalysisLine">
  ...
  <div class="my-4 row">
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab3" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#pendingReviewPie"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Pie</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#pendingReviewLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent4">
        ...
        <div class="tab-pane fade" id="pendingReviewLine" role="tabpanel" aria-labelledby="home-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Pending Review Analysis</h5>
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab3" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#pendingApprovalLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent4">
        ...
        <div class="tab-pane fade" id="pendingApprovalLine" role="tabpanel" aria-labelledby="home23-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Pending Approval Analysis</h5>
  ...
  <div class="my-4 row">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#reviewSixBar"
            type="button" role="tab" aria-controls="home" aria-selected="true">Bar</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#reviewSixLine" type="button"
            role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="reviewSixLine" role="tabpanel" aria-labelledby="home42-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Review in Next 6 Months</h5>
  ...
  <div class="my-4 row">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#reviewOneBar"
            type="button" role="tab" aria-controls="home" aria-selected="true">Bar</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#reviewOneLine" type="button"
            role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="reviewOneLine" role="tabpanel" aria-labelledby="home45-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Review in Next 1 Year</h5>
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#reviewTwoBar"
            type="button" role="tab" aria-controls="home" aria-selected="true">Bar</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#reviewTwoLine" type="button"
            role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="reviewTwoLine" role="tabpanel" aria-labelledby="home45-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Review in Next 2 Years</h5>
  ...
  <div class="my-4 row">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#originatorDistPie"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Pie</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#originatorDistLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="originatorDistLine" role="tabpanel" aria-labelledby="home45-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Originator Distribution</h5>
              ...
              <div
                class="card-text d-flex justify-content-center d-flex justify-content-center align-items-center h-100"
                id="documentOriginatorDistributionLine">
    ...
    <div class="col-sm-6">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#documentStatusPie"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Pie</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#documentStatusLine"
            type="button" role="tab" aria-controls="profile" aria-selected="false">Line</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="documentStatusLine" role="tabpanel" aria-labelledby="home45-tab">
          <div class="card border-0" style="width: 26rem;">
            <div class="card-body">
              <h5 class="card-title">Documents by status</h5>
  ...
  <script>
    ...
    function renderDocumentCategoryChart(series, labels) {
      ...
      var lineOptions = {
        ...
        markers: {
          size: 5, // Add markers to the line
          shape: 'circle'
        },
        dataLabels: {
          enabled: false
      ...
      var documentCategoryChartLine = new ApexCharts(document.querySelector("#documentCategoryChartLine"), lineOptions);
      documentCategoryChart.render();
      documentCategoryChartPie.render();
      documentCategoryChartLine.render();
    }
    ...
    function renderDocumentOriginatorChart(seriesData, labels) {
      ...
      var documentOriginatorDistributionLine = new ApexCharts(document.querySelector("#documentOriginatorDistributionLine"), lineOptions);
      documentOriginatorDistribution.render();
      documentOriginatorDistributionPie.render();
      documentOriginatorDistributionLine.render();
    }
    ...
    function renderDocumentSixChart(seriesData, labels) {
      ...
      var documentReviewSixLine = new ApexCharts(document.querySelector("#documentReviewSixLine"), lineOptions);
      documentReviewSix.render();
      documentReviewSixPie.render();
      documentReviewSixLine.render();
    }
    ...
    function renderDocumentOneChart(seriesData, labels) {
      ...
      var documentReviewOneLine = new ApexCharts(document.querySelector("#documentReviewOneLine"), lineOptions);
      documentReviewOne.render();
      documentReviewOnePie.render();
      documentReviewOnePie.render();
      documentReviewOneLine.render();
    }
    ...
    function renderDocumentTwoChart(seriesData, labels) {
      ...
      var documentReviewTwoLine = new ApexCharts(document.querySelector("#documentReviewTwoLine"), lineOptions);
      documentReviewTwo.render();
      documentReviewTwoPie.render();
      documentReviewTwoLine.render();
    }
    ...
    function renderPendingReviewerChart(seriesData, labels) {
      ...
      var pendingReviewAnalysisLine = new ApexCharts(document.querySelector("#pendingReviewAnalysisLine"), lineOptions);
      pendingReviewAnalysis.render();
      pendingReviewAnalysisBar.render();
      pendingReviewAnalysisLine.render();
    }
    ...
    function renderPendingApproverChart(seriesData, labels) {
      ...
      var pendingApproveAnalysisLine = new ApexCharts(document.querySelector("#pendingApproveAnalysisLine"), lineOptions);
      pendingApproveAnalysis.render();
      pendingApproveAnalysisPie.render();
      pendingApproveAnalysisLine.render();
    }
    ...
    function renderPendingHODChart(seriesData, labels) {
      ...
      var pendingHODAnalysisLine = new ApexCharts(document.querySelector("#pendingHODAnalysisLine"), lineOptions);
      pendingHODAnalysis.render();
      pendingHODAnalysisPie.render();
      pendingHODAnalysisLine.render();
    }
    ...
    function renderPendingTrainingChart(seriesData, labels) {
      ...
      var pendingTrainingAnalysisLine = new ApexCharts(document.querySelector("#pendingTrainingAnalysisLine"), lineOptions);
      pendingTrainingAnalysis.render();
      pendingTrainingAnalysisPie.render();
      pendingTrainingAnalysisLine.render();
    }
