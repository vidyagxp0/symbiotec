        ...
        <div class="block">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="w-30">
                        <div class="static"> @if($commnetData->initiator_update_complete_by) {{ $commnetData->initiator_update_complete_by }} @else Not Applicable @endif</div>
                    </td>
                    <th class="w-20">Initiator Updated Completed On </th>
                    <td class="w-30">
                        <div class="static">@if($commnetData->initiator_update_complete_on) {{ $commnetData->initiator_update_complete_on }} @else Not Applicable @endif</div>
                    </td>
                    <th class="w-20">Initiator Updated Completed Comments :</th>
                    <td class="w-30">
                        <div class="static"> @if($commnetData->initiator_update_complete_comment) {{ $commnetData->initiator_update_complete_comment }} @else Not Applicable @endif </div>
                    </td>
                </tr>
